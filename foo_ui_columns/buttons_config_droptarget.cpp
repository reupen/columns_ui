...
HRESULT STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::QueryInterface(
...
ULONG STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::AddRef()
{
    return InterlockedIncrement(&drop_ref_count);
}
ULONG STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::Release()
{
...
bool ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::check_do(IDataObject* pDO)
{
    bool rv = false;
    FORMATETC fe;
...
HRESULT STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::DragEnter(
...
HRESULT STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::DragOver(
...
HRESULT STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::DragLeave()
{
...
HRESULT STDMETHODCALLTYPE ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::Drop(
    IDataObject* pDataObj, DWORD grfKeyState, POINTL ptl, DWORD* pdwEffect)
{
    POINT pt = {ptl.x, ptl.y};
    if (m_DropTargetHelper.is_valid())
...
ButtonsToolbar::config_param::t_button_list_view::IDropTarget_buttons_list::IDropTarget_buttons_list(
    ButtonsToolbar::config_param::t_button_list_view* p_blv)
