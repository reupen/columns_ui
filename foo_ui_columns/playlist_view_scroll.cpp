...
void playlist_view::update_scrollbar(bool redraw)
{
    ...
    if (old_horizontal_offset != horizontal_offset)
        need_move = true;
    ...
    if (redraw_playlist) {
        {
            ...
            ScrollWindowEx(wnd_playlist, 0, (old_vert_pos - scroll_item_offset) * get_item_height(), &playlist,
                &playlist, nullptr, &rc_redraw, 0);
