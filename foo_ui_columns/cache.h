...
public:
    ...
    void make_extra(unsigned playlist, unsigned idx, global_variable_list& p_out, const SYSTEMTIME* st = nullptr,
        bool b_legacy = false) const;
...
public:
    ...
    void initialise()
    {
        ...
        playlist_api->register_callback(this,
            playlist_callback::flag_on_playlist_created | playlist_callback::flag_on_playlists_removed
                | playlist_callback::flag_on_playlists_reorder);
    }
    void deinitialise()
    {
        static_api_ptr_t<playlist_manager> playlist_api;
...
private:
    void FB2KAPI on_items_added(unsigned p_playlist, unsigned start,
        const pfc::list_base_const_t<metadb_handle_ptr>& p_data, const pfc::bit_array& p_selection) override{};
