...
cfg_string cfg_global_nontrack(create_guid(0x6c012fdb,0x30a4,0x398d,0x16,0xf1,0x75,0x27,0x99,0x77,0xc9,0x8f),"");
...
colourinfo * cache_manager::add_colour(/*COLORREF text, COLORREF text_sel, COLORREF back, COLORREF back_sel, COLORREF back_sel_nofocus*/colourinfo & colour_add)
{
...
void display_info::get_colour(colourinfo & out) {if (colours) colours->copy_to(out);};
...
void display_info::set_colour(/*COLORREF text, COLORREF text_sel, COLORREF back, COLORREF back_sel, COLORREF back_sel_nofocus*/colourinfo & colour_add)
{	
	if (colours) g_cache_manager.release_colour(colours);
...
//	display_data.get_item(column)->set_colour( strtoul(fore, 0, 16),strtoul(fore_sel, 0, 16),strtoul(back, 0, 16),strtoul(back_sel, 0, 16),strtoul(back_sel_no_focus, 0, 16));
}
