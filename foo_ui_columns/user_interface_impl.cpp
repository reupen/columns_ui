...
public:
    ...
    HWND init(HookProc_t hook) override
    {
        ...
        g_main_window
            = CreateWindowEx(main_window::config_get_transparency_enabled() ? WS_EX_LAYERED : 0 /*WS_EX_TOOLWINDOW*/,
                main_window_class_name, _T("foobar2000"),
                WS_OVERLAPPED | WS_MAXIMIZEBOX | WS_MINIMIZEBOX | WS_CAPTION | WS_SYSMENU | WS_CLIPCHILDREN
                    | WS_CLIPSIBLINGS | WS_THICKFRAME,
                left, top, cx, cy, nullptr, nullptr, core_api::get_my_instance(), nullptr);
    ...
    GUID get_guid() override
    {
        ...
        static const GUID guid_columns = {0xf12d0a24, 0xa8a4, 0x4618, {0x96, 0x59, 0x6f, 0x66, 0xde, 0x6, 0x75, 0x24}};
