...
colours_manager_data::entry_t::entry_t(bool b_global /*= false*/) : guid(pfc::guid_null), colour_mode(b_global ? (mmh::is_windows_vista_or_newer() ? cui::colours::colour_mode_themed : cui::colours::colour_mode_system) : cui::colours::colour_mode_global)
{
    reset_colors();
}
