    ...
    case WM_INITDIALOG: {
        ...
        try {
            ...
            m_is_font_fallback_available
                ...
                && win32::check_windows_10_build(16'299);
        ...
        if (m_is_font_fallback_available) {
            Button_SetCheck(m_use_custom_emoji_processing_checkbox,
                fonts::use_custom_emoji_processing ? BST_CHECKED : BST_UNCHECKED);
        ...
        if (!m_is_font_fallback_available) {
            ...
            uSetWindowText(notes_static_control,
                fmt::format("{}\n\nEmoji settings require Windows 10 version 1709 or newer.", notes_text.c_str())
                    .c_str());
        }
