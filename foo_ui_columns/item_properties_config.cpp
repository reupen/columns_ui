...
selection_properties_config_t::selection_properties_config_t(const pfc::list_t<field_t> & p_fields, t_size edge_style, t_uint32 info_sections_mask, bool b_show_columns, bool b_show_groups) : m_fields(p_fields), m_field_list(m_fields), m_edge_style(edge_style), m_initialising(false),
