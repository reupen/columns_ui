...
fbh::ConfigString config_status_bar_script(
    GUID{0xb5ca645b, 0xa5e0, 0x4c70, {0xa5, 0x98, 0xcd, 0x62, 0x5c, 0xf3, 0xcc, 0x37}}, default_status_pane_script,
...
cfg_bool cfg_firstrun(GUID{0xf7c0139, 0x8698, 0x42bd, {0xb2, 0xe0, 0x3f, 0x59, 0x94, 0xaa, 0xde, 0x43}}, true),
    cfg_activate_target_playlist_on_dropped_items(guid_activate_target_playlist_on_dropped_items,
        config_get_activate_target_playlist_on_dropped_items_default_value());

cfg_int cfg_transparency_enabled(GUID{0xd5ab3806, 0x8670, 0xf09d, {0x47, 0xdd, 0x1f, 0x45, 0x05, 0x8d, 0x83, 0x8f}},
    config_get_transparency_enabled_default_value()),
    cfg_transparency_level(GUID{0x7d50b4ac, 0xfcd4, 0x0a98, {0xd3, 0x64, 0x58, 0xc8, 0x2e, 0x56, 0x19, 0xd7}},
        config_get_transparency_level_default_value()),
    cfg_status_show_lock(GUID{0x0ec529ab, 0xa4cb, 0x0fa9, {0xa1, 0xbc, 0x7d, 0x24, 0x56, 0xdc, 0xb5, 0x40}},
        config_get_status_show_lock_default_value());
...
void config_set_status_show_lock(bool b_val)
{
    ...
    cui::status_bar::set_part_sizes(cui::status_bar::t_part_lock | cui::status_bar::t_part_length
        | cui::status_bar::t_part_count | cui::status_bar::t_part_volume);
}
...
{
    return cfg_activate_target_playlist_on_dropped_items;
}
...
{
    cfg_activate_target_playlist_on_dropped_items = b_val;
}
void config_reset_activate_target_playlist_on_dropped_items()
{
    config_set_activate_target_playlist_on_dropped_items(
        config_get_activate_target_playlist_on_dropped_items_default_value());
}
