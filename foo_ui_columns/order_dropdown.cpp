...
class order_extension : public ui_extension::container_ui_extension, public playlist_callback_single
{
...
LRESULT order_extension::on_message(HWND wnd,UINT msg,WPARAM wp,LPARAM lp)
{
	if(msg == WM_CREATE)
	{
		...
		if (wnd_combo)
		{
			...
			uComboBox_SelectString(wnd_combo, playlist_api->playback_order_get_name(playlist_api->playback_order_get_active()));
