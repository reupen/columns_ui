...
namespace filter_panel {
	...
	// {236DCBF0-03CC-4D67-A45B-26C6D44CFAC9}
	const GUID g_guid_show_column_titles =
	{ 0x236dcbf0, 0x3cc, 0x4d67, { 0xa4, 0x5b, 0x26, 0xc6, 0xd4, 0x4c, 0xfa, 0xc9 } };

	// {874794A3-904C-4FDA-8DF6-2ADA01E3697A}
	const GUID g_guid_allow_sorting =
	{ 0x874794a3, 0x904c, 0x4fda,{ 0x8d, 0xf6, 0x2a, 0xda, 0x1, 0xe3, 0x69, 0x7a } };

	// {71E31F54-F410-4F76-846D-8586723ECC8A}
	const GUID g_guid_show_sort_indicators =
	{ 0x71e31f54, 0xf410, 0x4f76,{ 0x84, 0x6d, 0x85, 0x86, 0x72, 0x3e, 0xcc, 0x8a } };	

	// {9D857B0B-4FEF-453A-8FDB-DE4497546D70}
	const GUID g_guid_cfg_summary_fields =
	{ 0x9d857b0b, 0x4fef, 0x453a,{ 0x8f, 0xdb, 0xde, 0x44, 0x97, 0x54, 0x6d, 0x70 } };
}