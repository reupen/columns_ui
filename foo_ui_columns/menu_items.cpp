...
namespace mainmenu_groups_columns
{
	...
	const GUID view_columns_part = 
	{ 0xae078354, 0x60ea, 0x48a9, { 0x94, 0x5, 0xda, 0xa, 0xef, 0x0, 0xc5, 0x8d } };

	// {16610091-8BD9-4e38-9DE5-4329BE14121B}
	const GUID view_playlist_popup = 
	{ 0x16610091, 0x8bd9, 0x4e38, { 0x9d, 0xe5, 0x43, 0x29, 0xbe, 0x14, 0x12, 0x1b } };

	// {0CEF3F5A-02C3-4865-8F62-379280E4EC3A}
	const GUID playlist_font_part = 
	{ 0xcef3f5a, 0x2c3, 0x4865, { 0x8f, 0x62, 0x37, 0x92, 0x80, 0xe4, 0xec, 0x3a } };

	// {F74D3C19-91CC-4179-954A-7BE54E9BBC80}
	const GUID playlist_misc_part = 
	{ 0xf74d3c19, 0x91cc, 0x4179, { 0x95, 0x4a, 0x7b, 0xe5, 0x4e, 0x9b, 0xbc, 0x80 } };

	// {533FDC34-EE1B-4317-9D0C-489EE1215D9F}
	const GUID view_layout_popup = 
	{ 0x533fdc34, 0xee1b, 0x4317, { 0x9d, 0xc, 0x48, 0x9e, 0xe1, 0x21, 0x5d, 0x9f } };

	// {964C3B5A-1908-4407-9B8E-FC7331A99ED1}
	const GUID view_layout_commands = 
	{ 0x964c3b5a, 0x1908, 0x4407, { 0x9b, 0x8e, 0xfc, 0x73, 0x31, 0xa9, 0x9e, 0xd1 } };

	// {C36EF588-ABDF-495e-A7D4-D021846F50EE}
	const GUID view_layout_presets = 
	{ 0xc36ef588, 0xabdf, 0x495e, { 0xa7, 0xd4, 0xd0, 0x21, 0x84, 0x6f, 0x50, 0xee } };
}

mainmenu_group_factory g_mainmenu_group_view_columns_part(mainmenu_groups_columns::view_columns_part, mainmenu_groups::view, mainmenu_commands::sort_priority_base+1);
mainmenu_group_popup_factory g_mainmenu_group_view_playlist_popup(mainmenu_groups_columns::view_playlist_popup, mainmenu_groups_columns::view_columns_part, mainmenu_commands::sort_priority_base, "Columns playlist");
mainmenu_group_popup_factory g_mainmenu_group_view_layout_popup(mainmenu_groups_columns::view_layout_popup, mainmenu_groups_columns::view_columns_part, mainmenu_commands::sort_priority_base+1, "Layout");
mainmenu_group_factory g_mainmenu_group_playlist_font_part(mainmenu_groups_columns::playlist_font_part, mainmenu_groups_columns::view_playlist_popup, mainmenu_commands::sort_priority_base);
mainmenu_group_factory g_mainmenu_group_playlisy_misc_part(mainmenu_groups_columns::playlist_misc_part, mainmenu_groups_columns::view_playlist_popup, mainmenu_commands::sort_priority_base+1);
...
const mainmenu_command_t * const g_mainmenu_commands_view_layout_commands_part[] = {&g_mainmenu_layout_live_edit/*,&g_mainmenu_export_layout,&g_mainmenu_import_layout*/};
...
{
public:
	static const mainmenu_command_t * const * const get_ptr() {return &g_mainmenu_commands_view_layout_commands_part[0];}
...
mainmenu_commands_factory_t<mainmenu_commands_t<mainmenu_command_list_playlist_font_part_t > > g_mainmenu_commands_playlist_font;
mainmenu_commands_factory_t<mainmenu_commands_t<mainmenu_command_list_view_columns_part_t > > g_mainmenu_commands_columns;
mainmenu_commands_factory_t<mainmenu_commands_t<mainmenu_command_list_playlist_misc_part_t > > g_mainmenu_commands_playlist_misc;
mainmenu_commands_factory_t<mainmenu_commands_t<mainmenu_command_list_view_layout_commands_part_t > > g_mainmenu_commands_layout_commands;
