...
fbh::ConfigBool use_legacy_splitter_child_sizing(
    {0x5fecdd1e, 0x9db6, 0x40ab, {0x94, 0x24, 0x3e, 0x6e, 0x5d, 0x2d, 0xc3, 0x96}}, true);
...
fbh::ConfigBool use_hardware_acceleration(
    {0xd3ef5229, 0x237b, 0x4a90, {0xa8, 0xb8, 0xd6, 0x07, 0x30, 0xdb, 0x7a, 0x20}}, false);

fbh::ConfigObjectBoolFactory use_smooth_scrolling(
    GUID{0xcd15cb5d, 0x95f8, 0x4b09, {0xae, 0x3f, 0x0e, 0x3a, 0x50, 0x12, 0x71, 0xf0}}, false);

} // namespace cui::config

cfg_int cfg_global(GUID{0xf939e07d, 0x0944, 0x0f40, {0xbf, 0x1f, 0x6d, 0x31, 0xaa, 0x37, 0x10, 0x5f}}, 0);
cfg_int cfg_lock(GUID{0x93843978, 0xae88, 0x5ba2, {0x3c, 0xa6, 0xbc, 0x00, 0xb0, 0x78, 0x74, 0xa5}}, 0);
cfg_int cfg_header(GUID{0x7b92fba5, 0x91a8, 0x479e, {0x3e, 0xb9, 0x0a, 0x26, 0x44, 0x8b, 0xef, 0x1c}}, 1);
cfg_int cfg_show_seltime(GUID{0x7e70339b, 0x877f, 0xc4a5, {0x02, 0xbc, 0xee, 0x6e, 0x9d, 0x9d, 0x01, 0xc9}}, 1);
cfg_int cfg_show_selcount(GUID{0xc48b9584, 0x7063, 0x4732, {0xa5, 0x2d, 0xe3, 0xc9, 0xc4, 0x61, 0x77, 0xa4}}, 1);
cfg_int cfg_header_hottrack(GUID{0xc61d7603, 0xfb21, 0xf362, {0xb9, 0xcd, 0x95, 0x2c, 0x82, 0xf9, 0xe5, 0x8e}}, 1);
cfg_int cfg_drop_at_end(GUID{0xd72ab7ee, 0x271c, 0xa72f, {0x69, 0x47, 0xb7, 0x26, 0x2c, 0x38, 0xb1, 0x60}}, 0);
cfg_int cfg_global_sort(GUID{0xdf68f654, 0x4c01, 0x9d16, {0x0d, 0xb5, 0xc2, 0x77, 0x95, 0x8d, 0x8f, 0xfa}}, 0);
cfg_int cfg_mclick(GUID{0xfab4859d, 0x72ae, 0xd27e, {0xb1, 0x19, 0xd6, 0xfe, 0x88, 0x4b, 0x67, 0x93}}, 0);
cfg_int cfg_mclick2(GUID{0x41fbf3da, 0x4026, 0x2505, {0xbd, 0x7a, 0x53, 0x76, 0x73, 0x51, 0x0f, 0x3e}}, 1);
cfg_int cfg_plm_rename(GUID{0xc793fce9, 0xa0e8, 0xc235, {0xd4, 0x3b, 0xe4, 0xdd, 0x2c, 0xd0, 0x45, 0xb7}}, 1);
cfg_int cfg_balloon(GUID{0x55a67634, 0x1a85, 0xf736, {0x5f, 0xce, 0x00, 0xdf, 0xd4, 0xd9, 0x10, 0x02}}, 0);
cfg_int cfg_ellipsis(GUID{0xb6fe16e9, 0x0502, 0x2b66, {0x45, 0xd1, 0xda, 0xfb, 0xfc, 0x37, 0xe0, 0x33}}, 1);
cfg_int cfg_frame(GUID{0x992ece57, 0xc20d, 0x167c, {0x34, 0x40, 0x80, 0x5e, 0x08, 0x1f, 0x91, 0x14}}, 0);
cfg_int cfg_plistframe(GUID{0xdbfdc16f, 0x8cfa, 0xcc63, {0xa2, 0xec, 0x17, 0xde, 0xa8, 0xc6, 0xdc, 0xa1}}, 0);
cfg_int cfg_tooltips_clipped(GUID{0x8181afae, 0x404e, 0xa880, {0xe2, 0x46, 0x38, 0x69, 0xbd, 0xc9, 0xd3, 0xef}}, 1);
cfg_int cfg_np(GUID{0x2e590774, 0xc50e, 0xbcd0, {0x73, 0xa2, 0x75, 0x2f, 0x70, 0x9b, 0xb1, 0x2e}}, 1);
cfg_int cfg_show_systray(GUID{0x19cf6962, 0x3d1e, 0x10b7, {0xcd, 0x91, 0x48, 0x66, 0x8b, 0x72, 0xe8, 0x22}}, 0);
cfg_int cfg_minimise_to_tray(GUID{0x4c4bf8f0, 0x1f76, 0x65f4, {0x52, 0xe4, 0x78, 0x01, 0x45, 0x13, 0xf9, 0x79}}, 0);
cfg_int cfg_show_vol(GUID{0xa325cde8, 0xc0df, 0x96f4, {0x90, 0xe9, 0x55, 0xbd, 0xe7, 0xd0, 0x32, 0xb9}}, 1);
cfg_int cfg_custom_icon(GUID{0xb45bfb84, 0x3ecd, 0xe706, {0x6e, 0x13, 0xa3, 0x2a, 0xd0, 0x2f, 0xac, 0x5f}}, 0);
cfg_int cfg_drag_autoswitch(GUID{0x593b498d, 0x4cc7, 0x1ec8, {0xb9, 0x20, 0x3c, 0x95, 0xb2, 0xde, 0x70, 0x8c}}, 0);
cfg_int cfg_plist_width(GUID{0x05aba8c0, 0x3460, 0x3c58, {0x20, 0xa0, 0x00, 0x6a, 0x54, 0x23, 0x5c, 0x3a}}, 135);
cfg_int cfg_drag_pl(GUID{0x56a9c8d8, 0x51fe, 0xac6f, {0x29, 0xe6, 0x29, 0xb3, 0x58, 0x82, 0xa7, 0x26}}, 1);
cfg_int cfg_pl_autohide(GUID{0x70cb66a7, 0xbe89, 0x8589, {0x53, 0x6c, 0x2b, 0x81, 0xdb, 0xa6, 0x72, 0x79}}, 0);
cfg_int cfg_sel_dp(GUID{0x3586f434, 0x1896, 0xecaa, {0xee, 0x61, 0x65, 0x61, 0xc1, 0x09, 0xd4, 0xcb}}, 0);
cfg_int cfg_replace_drop_underscores(
    GUID{0x73612560, 0xa7f0, 0x3d30, {0xb3, 0x2b, 0x8d, 0xd7, 0xe6, 0x5f, 0xfa, 0x91}}, 0);
cfg_int cfg_tabs_multiline(GUID{0xbb86aba9, 0x8402, 0xb932, {0x7a, 0xfd, 0xf3, 0xc9, 0xd5, 0x40, 0xfe, 0x2e}}, 1);
cfg_int cfg_status(GUID{0x79829634, 0x9b73, 0xa8bb, {0x89, 0x39, 0xf1, 0x70, 0xf7, 0x38, 0xe8, 0x5e}}, 0);
cfg_int cfg_pgen_tf(GUID{0xdc10bfe5, 0xe91b, 0x513e, {0xb9, 0xcb, 0xc4, 0xef, 0xd9, 0xed, 0xac, 0x25}}, 0);
cfg_int cfg_cur_prefs_col(GUID{0x6b77648d, 0x35ec, 0xb125, {0x49, 0xea, 0xa2, 0xe6, 0xd8, 0xa8, 0xed, 0x0c}}, 0);
cfg_int cfg_playlist_switcher_use_tagz(
    GUID{0x43d94259, 0x4fde, 0x8779, {0x8e, 0xde, 0x18, 0xca, 0xa7, 0x2f, 0xc5, 0x7b}}, 1);
cfg_int cfg_sidebar_use_custom_show_delay(
    GUID{0x59e44486, 0x2dcc, 0x1276, {0x83, 0x84, 0xcf, 0xcb, 0xc0, 0x4f, 0xb4, 0x1c}}, 0);
cfg_int cfg_sidebar_show_delay(GUID{0xad46e438, 0x269d, 0xe1c8, {0x4a, 0xe0, 0x08, 0x29, 0xb5, 0x5d, 0x2f, 0xc3}}, 0);
cfg_int cfg_sidebar_hide_delay(GUID{0xab13b5dc, 0x1baa, 0x937a, {0x85, 0x33, 0x2d, 0x58, 0x35, 0xc8, 0xe7, 0xa8}}, 0);
cfg_int cfg_toolbars(GUID{0xfd1f165e, 0xeb6e, 0xbb2d, {0xe0, 0xd7, 0xc5, 0x03, 0xee, 0xf1, 0x6d, 0xd7}}, 1);
cfg_int cfg_show_sort_arrows(GUID{0xa9f1111e, 0x68d6, 0xc707, {0xd4, 0xad, 0x09, 0x63, 0x72, 0x0b, 0xe9, 0xfa}}, 1);
cfg_int cfg_autoswitch_delay(GUID{0x11645dab, 0xf8a6, 0xdc4e, {0x1d, 0xc0, 0xce, 0x50, 0xb1, 0x27, 0xb5, 0xbb}}, 500);
cfg_int cfg_alternative_sel(GUID{0xfd0cdf1f, 0x588a, 0x1a2a, {0xdc, 0x70, 0x31, 0x06, 0x79, 0x41, 0x52, 0xe2}}, 0);
cfg_int cfg_playlist_middle_action(
    GUID{0xbda32fa2, 0xfb5a, 0xb715, {0x3f, 0x00, 0xcf, 0xaf, 0x9b, 0x57, 0xcd, 0x2c}}, 0);
cfg_int cfg_nohscroll(GUID{0x75ede7f7, 0x8c57, 0x03d9, {0x51, 0xa2, 0xe4, 0xe3, 0xdd, 0x7c, 0x8c, 0x74}}, 1);

cfg_bool cfg_main_window_is_hidden(
    GUID{0x4655434b, 0x4655, 0x434b, {0x46, 0x55, 0x43, 0x4b, 0x46, 0x55, 0x43, 0x4b}}, false);
...
ConfigColumns g_columns(guid_columns);
