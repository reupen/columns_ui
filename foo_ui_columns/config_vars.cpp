...
namespace settings
{
    ...
    fbh::ConfigInt32DpiAware playlist_switcher_item_padding(GUID{0xc8f7e065, 0xeb66, 0xe282, 0xbd, 0xe3, 0x70, 0xaa, 0xf4, 0x3a, 0x10, 0x97}, 2),
            playlist_view_item_padding(GUID{0x032abfcb, 0x6cab, 0x25ee, 0x9d, 0xe8, 0x27, 0x89, 0xa9, 0x0a, 0x72, 0x36}, 2);
...
cfg_int
    cfg_global(GUID{0xf939e07d, 0x0944, 0x0f40, 0xbf, 0x1f, 0x6d, 0x31, 0xaa, 0x37, 0x10, 0x5f}, 0),
    cfg_vis(GUID{0x2bb960d2, 0xb1a8, 0x5741, 0x55, 0xb6, 0x13, 0x3f, 0xb1, 0x80, 0x37, 0x88}, get_default_colour(colours::COLOUR_BACK)),
    cfg_vis_edge(GUID{0x57cd2544, 0xd765, 0xef88, 0x30, 0xce, 0xd9, 0x9b, 0x47, 0xe4, 0x09, 0x94}, 1),
    cfg_vis2(GUID{0x421d3d3f, 0x5289, 0xb1e4, 0x9b, 0x91, 0xab, 0x51, 0xd3, 0xad, 0xbc, 0x4d}, get_default_colour(colours::COLOUR_TEXT)),
    ...
    cfg_frame(GUID{0x992ece57, 0xc20d, 0x167c, 0x34, 0x40, 0x80, 0x5e, 0x08, 0x1f, 0x91, 0x14}, 2),
    ...
    cfg_show_systray(GUID{0x19cf6962, 0x3d1e, 0x10b7, 0xcd, 0x91, 0x48, 0x66, 0x8b, 0x72, 0xe8, 0x22}, 1),
    cfg_minimise_to_tray(GUID{0x4c4bf8f0, 0x1f76, 0x65f4, 0x52, 0xe4, 0x78, 0x01, 0x45, 0x13, 0xf9, 0x79}, 1),
    ...
    cfg_playlist_sidebar_tooltips(GUID{0x0f6ad5ac, 0x7409, 0x151e, 0xe0, 0xd7, 0x61, 0xe5, 0xd8, 0x53, 0x9b, 0x4c}, 1),
    cfg_playlist_switcher_use_tagz(GUID{0x43d94259, 0x4fde, 0x8779, 0x8e, 0xde, 0x18, 0xca, 0xa7, 0x2f, 0xc5, 0x7b}, 0),
    cfg_sidebar_use_custom_show_delay(GUID{0x59e44486, 0x2dcc, 0x1276, 0x83, 0x84, 0xcf, 0xcb, 0xc0, 0x4f, 0xb4, 0x1c}, 0),
    ...
    cfg_playlist_date(GUID{0xe0f9c009, 0x89f2, 0x4a6e, 0xdd, 0xb5, 0x10, 0x30, 0x0c, 0xc3, 0x74, 0xce}, 0),
    ...
    cfg_oldglobal(GUID{0x512eace5, 0x25c3, 0xb722, 0x28, 0x8b, 0xb3, 0x4a, 0xc5, 0x80, 0xf4, 0xbf}, 0),
...
cfg_bool cfg_go_to_tray(GUID{0x4655434b, 0x4655, 0x434b, 0x46, 0x55, 0x43, 0x4b, 0x46, 0x55, 0x43, 0x4b}, 0);
...
cfg_string cfg_custom_buttons_path(GUID{0x3d077fbb, 0x47f2, 0x7c15, 0x7a, 0x3d, 0xa1, 0x09, 0x20, 0xa8, 0xd5, 0x85}, "");
cfg_string cfg_globalstring(GUID{0x355320ea, 0xf39e, 0x0d97, 0xa5, 0x94, 0xe0, 0x40, 0x57, 0x66, 0x51, 0x25}, "");
cfg_menu_item cfg_statusdbl(GUID{0x21440b3f, 0x4c1d, 0xb049, 0x46, 0xe1, 0x37, 0xa2, 0x7e, 0xc1, 0xe6, 0x93}, mainmenu_activate_now_playing_t::g_guid);
cfg_string cfg_pgenstring(GUID{0x07bee8c2, 0xc6f1, 0x9db3, 0x52, 0x55, 0x43, 0x28, 0x1f, 0xb3, 0xf1, 0xe6}, "%album%\\$directory(%_path%,2)");
...
cfg_string cfg_colour(GUID{0xa41b3a98, 0x3834, 0x3b7c, 0x58, 0xae, 0x1d, 0x46, 0xb0, 0xf9, 0x4b, 0x0d}, g_default_colour);

cfg_menu_item cfg_playlist_double(GUID{0xffc47d9d, 0xb43d, 0x8fad, 0x8f, 0xb3, 0x42, 0x84, 0xbf, 0x9a, 0x22, 0x2a});
cfg_string cfg_playlist_switcher_tagz(GUID{0x13f4b9ae, 0x5db5, 0xb083, 0x15, 0x36, 0x08, 0x4d, 0x55, 0xe3, 0xb5, 0x64}, "%title%");
