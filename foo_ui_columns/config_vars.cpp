...
fbh::ConfigInt32DpiAware playlist_switcher_item_padding(
    GUID{0xc8f7e065, 0xeb66, 0xe282, 0xbd, 0xe3, 0x70, 0xaa, 0xf4, 0x3a, 0x10, 0x97}, 2),
...
cfg_menu_item cfg_statusdbl(GUID{0x21440b3f, 0x4c1d, 0xb049, 0x46, 0xe1, 0x37, 0xa2, 0x7e, 0xc1, 0xe6, 0x93},
    mainmenu_activate_now_playing_t::g_guid);
cfg_string cfg_pgenstring(
    GUID{0x07bee8c2, 0xc6f1, 0x9db3, 0x52, 0x55, 0x43, 0x28, 0x1f, 0xb3, 0xf1, 0xe6}, "%album%\\$directory(%_path%,2)");
...
cfg_string cfg_playlist_switcher_tagz(
    GUID{0x13f4b9ae, 0x5db5, 0xb083, 0x15, 0x36, 0x08, 0x4d, 0x55, 0xe3, 0xb5, 0x64}, "%title%");
...
cfg_window_placement_t cfg_window_placement_columns(
...
cfg_window_placement_t::cfg_window_placement_t(const GUID& p_guid)
