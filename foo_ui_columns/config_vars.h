...
extern cfg_int cfg_global, cfg_cur_prefs_col, cfg_header_hottrack, cfg_sortsel, cfg_global_sort, cfg_vis, cfg_vis2,
    ...
    cfg_ellipsis, cfg_tabs_multiline, cfg_frame, cfg_show_seltime, cfg_plistframe, cfg_tooltip, cfg_tooltips_clipped,
    cfg_np, cfg_show_systray, cfg_minimise_to_tray, cfg_show_vol, cfg_custom_icon, cfg_custom_buttons,
    cfg_drag_autoswitch, cfg_plist_width, cfg_drag_pl, cfg_pl_autohide, cfg_sel_dp, cfg_alternative_sel, cfg_plm_rename,
    cfg_pgen_playlist, cfg_pgen_tf, cfg_autoswitch_delay, cfg_pgen_dir, cfg_custom_buttons_over,
    cfg_custom_buttons_transparency, cfg_replace_drop_underscores, cfg_status, cfg_show_sort_arrows,
