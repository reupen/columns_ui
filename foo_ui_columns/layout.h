...
public:
	...
	bool import_config_to_object(stream_reader * p_reader, t_size size, t_uint32 mode, cfg_layout_t::preset & p_out, pfc::list_base_t<GUID> & panels, abort_callback & p_abort);
