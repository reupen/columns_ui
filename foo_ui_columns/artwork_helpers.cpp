...
void artwork_panel::ArtworkReaderManager::set_types(std::vector<GUID> types)
{
...
bool artwork_panel::ArtworkReader::are_contents_equal(const std::unordered_map<GUID, album_art_data_ptr>& content1,
