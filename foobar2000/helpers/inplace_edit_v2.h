namespace InPlaceEdit {
	...
	class CTableEditHelperV2_ListView : public CTableEditHelperV2 {
	public:
		...
		//IDIOCY: Can't retrieve column count from a listview cleanly. Implementers must supply their own TableEdit_GetColumnCount().
