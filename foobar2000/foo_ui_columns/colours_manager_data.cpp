...
colours_manager_data::entry_t::entry_t(bool b_global /*= false*/) : guid(pfc::guid_null), colour_mode(b_global ? (is_vista_or_newer() ? cui::colours::colour_mode_themed : cui::colours::colour_mode_system) : cui::colours::colour_mode_global)
{
	reset_colors();
}
...
void colours_manager_data::entry_t::export(stream_writer * p_stream, abort_callback & p_abort)
{
