...
public:
	...
	volume_control_t() : wnd_trackbar(NULL), m_track_bar_host(this), m_child(this), m_Gdiplus_token(NULL), m_using_gdiplus(false) {};
	~volume_control_t() {};
...
typedef volume_control_t<true, true, volume_popup_class_name> volume_control;
