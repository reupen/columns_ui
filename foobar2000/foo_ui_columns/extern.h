...
extern cfg_int cfg_back,
	...
	//cfg_plist_selected_text_no_focus,
...
namespace menu_info
{
	extern service_ptr_t<contextmenu_manager> g_main_menu_a;
	extern unsigned MENU_A_BASE ;
	extern service_ptr_t<contextmenu_manager> g_main_menu_b ;
	extern unsigned MENU_B_BASE;
}
#endif


//extern contextmenu_manager* g_main_menu_a;
...
//extern playlist_entries g_playlist_entries;
//extern sort g_sort;
