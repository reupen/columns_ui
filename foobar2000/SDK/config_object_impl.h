...
{
public:
	config_object_string_factory(const GUID & p_guid,const char * p_string,t_size p_string_length = pfc_infinite)
		: config_object_factory(p_guid,p_string,pfc::strlen_max(p_string,pfc_infinite)) {}
